...
output "france_prod_backend_ip" {
  value = module.france_prod.backend_instance_ip
}

output "france_prod_frontend_ip" {
  value = module.france_prod.frontend_instance_ip
}
...
output "ssh_private_keys" {
  value = {
    ...
    france_prod_backend  = module.france_prod.backend_ssh_private_key
    france_prod_frontend = module.france_prod.frontend_ssh_private_key
